 ...
 created with UNIX on "Thursday, September 24, 1998 at 16:12." 
  COMMAND LINE: "./ftangle ./custom -uSUN -mIBMPC -mCC -= /u/krommes/Fweb/1.62/Boot/ibm/pc/microsoft/custom.h -# -v"
...
#define THE_SYSTEM  "IBM-PC/MSDOS"
...
#define PRINT_AVAILABLE_MEMORY 1
