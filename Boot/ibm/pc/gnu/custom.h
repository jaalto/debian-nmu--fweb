 ...
 created with UNIX on "Thursday, September 24, 1998 at 16:12." 
  COMMAND LINE: "./ftangle ./custom -uSUN -mANSI -mCC -mSYS_NAME= MSDOS/GNU -mF_CALLS= 1 -mPREFIX_END_CHR= '\\' -mNULL_NAME= NUL -= /u/krommes/Fweb/1.62/Boot/ibm/pc/gnu/custom.h -# -v"
